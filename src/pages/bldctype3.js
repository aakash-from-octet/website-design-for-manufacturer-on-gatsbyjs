        ...
        <div className="grid  md:grid-cols-2 md:gap-[80px] w-[90%] md:w-[85%] mx-auto items-start">
          <div className="mb-[40px]  md:flex md:justify-center min-w-[300px]">
            ...
            <div className="relative w-full flex justify-center">
              ...
              {is2D ? (
                <StaticImage
                  src="../images/AL57BLS03-36-4000MJ2.png"
                  alt="alto logo"
                  width={350}
                  height={300}
                  className=""
                ...
                <iframe className={show3D ? "3d-modal mt-[100px] min-w:[300px] md:min-w-[399px]" : "3d-modal hidden"} scrolling='no' title="AL57BLS03" frameborder='0' allowfullscreen='true' src='https://www.3dcontentcentral.com/external-site-embed.aspx?format=3D&catalogid=14959&modelid=2276853&width=250&height=250&edraw=true' name='PreviewFrame3D' id='PreviewFrame3D' height='355'></iframe>
                ...
                <div className="pb-[22px] border-b border-[#E9E9E9]">
                  ...
                  <div className="flex flex-col md:gap-[15px]">
                    <div className="flex justify-between">
                      ...
                      <p className="">108 mm</p>
                    </div>
                    <div className="flex justify-between">
                      <p className="md:text-[16px] leading-[20px] tracking-[.48px] text-[#888888] ">
                        Resistance
                      </p>
                      <p className="">0.45 Ω</p>
                    </div>
                    <div className="flex justify-between">
                      <p className="md:text-[16px] leading-[20px] tracking-[.48px] text-[#888888] ">
                        Inductance
                      </p>
                      <p className="">1.5 mH</p>
                    </div>
                    <div className="flex justify-between">
                      <p className="md:text-[16px] leading-[20px] tracking-[.48px] text-[#888888] ">
                        Back Emf
