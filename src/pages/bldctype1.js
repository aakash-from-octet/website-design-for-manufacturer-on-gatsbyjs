        ...
        <div className="grid  md:grid-cols-2 md:gap-[80px] w-[90%] md:w-[85%] mx-auto items-start">
          <div className="mb-[40px]  md:flex md:justify-center min-w-[300px]">
            ...
            <div className="relative w-[100%] flex justify-center">
              ...
              {is2D ? (
                <StaticImage
                  src="../images/AL57BLS01-36-4000MJ2.png"
                  alt="alto logo"
                  width={350}
                  height={300}
                  className="2d-image"
                ...
                <iframe
                  className={show3D ? "3d-modal mt-[100px] min-w:[300px] md:min-w-[399px]" : "3d-modal hidden"}
                  scrolling='no'
                  title="AL57BLS01"
                  frameBorder='0'
                  allowFullScreen='true'
                  src='https://www.3dcontentcentral.com/external-site-embed.aspx?format=3D&catalogid=14959&modelid=2276855&width=250&height=250&edraw=true'
                  name='PreviewFrame3D'
                  id='PreviewFrame3D'
                ...
                <div className="pb-[22px] border-b border-[#E9E9E9]">
                  ...
                  <div className="flex flex-col md:gap-[15px]">
                    ...
                    <div className="flex justify-between">
                      ...
                      <p className="">1.63 Ω</p>
                    </div>
                    <div className="flex justify-between">
                      <p className="md:text-[16px] leading-[20px] tracking-[.48px] text-[#888888] ">
                        Inductance
                      </p>
                      <p className="">4.4 mH</p>
                    </div>
                    <div className="flex justify-between">
                      <p className="md:text-[16px] leading-[20px] tracking-[.48px] text-[#888888] ">
                        Back Emf
                ...
                <div className="py-[22px]  border-b border-[#E9E9E9]">
                  ...
                  <div className="flex flex-col md:gap-[20px]">
                    <div className="flex justify-between">
                      ...
                      <p className="">10.2 A</p>
                    </div>
                    <div className="flex justify-between">
                      <p className="md:text-[16px] leading-[20px] tracking-[.48px] text-[#888888] ">
                        Torque
                      </p>
                      <p className="">0.33 Nm</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className='features gap-[40px] md:gap-[60px] p-[30px] md:p-[40px] border border-1 border-[#f0f0f0]'>
          <div className='w-[100%]'>
            ...
            <div className='flex flex-col md:flex-row gap-[14px]'>
              ...
              <ul className="flex flex-col gap-[14px]  max-w-md-[553px] w-[100%]">
