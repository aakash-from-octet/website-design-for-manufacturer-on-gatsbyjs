...
export default function Bldc10() {
                ...
                <div className='grid  md:grid-cols-2 md:gap-[80px] w-[90%] md:w-[85%] mx-auto items-center'>
                    <div className='mb-[40px]  min-w-[300px] md:flex md:justify-center md:self-start'>
                        <div className='mt-[70px] mb-[20px] md:hidden flex justify-between relative'>
                            <div>
                                <p className='text-[26px] font-normal leading-[35px] tracking-[1.2px] '>DRV-BL120</p>
                        ...
                        <div className="relative w-full flex justify-center">
                            ...
                            {is2D ? (
                                ...
                                <iframe className={show3D ? "3d-modal mt-[100px] min-w:[300px] md:min-w-[399px]" : "3d-modal hidden"} scrolling='no' title='DRV-BL120' frameborder='0' allowfullscreen='true' src='https://www.3dcontentcentral.com/external-site-embed.aspx?format=3D&catalogid=14959&modelid=2276856&width=250&height=250&edraw=true' name='PreviewFrame3D' id='PreviewFrame3D' height='355'></iframe>
                    ...
                    <div className=''>
                        <div className='mb-[30px] hidden md:block'>
                            <p className='text-[40px] font-bold leading-[54px] tracking-[1.2px] '>DRV-BL120</p>
