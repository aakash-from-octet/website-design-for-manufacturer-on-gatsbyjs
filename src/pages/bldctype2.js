...
// const AnimateThree = React.lazy(() => import("../components/ThreeDObj"));
          ...
          <div className="mb-[40px] md:flex md:justify-center min-w-[300px]">
            ...
            <div className="relative w-full flex justify-center">
              ...
              {is2D ? (
                ...
                <StaticImage
                  src="../images/AL57BLS02-36-4000MJ2.png"
                  alt="alto logo"
                  width={350}
                  height={300}
                  className="2d-image"
                ...
                <iframe className={show3D ? "3d-modal mt-[100px] min-w:[300px] md:min-w-[399px]" : "3d-modal hidden"} scrolling='no' title="AL57BLS02" frameborder='0' allowfullscreen='true' src='https://www.3dcontentcentral.com/external-site-embed.aspx?format=3D&catalogid=14959&modelid=2276854&width=250&height=250&edraw=true' name='PreviewFrame3D' id='PreviewFrame3D' height='355'></iframe>
